...
document.getElementById("btnItemTags").onclick = openTagModal;
document.getElementById("btnCloseTagModal").onclick = () =>
...
document.getElementById("newTagName").onkeydown = (e) => {
...
document.getElementById("btnMigrateTags").onclick = async () => {
  const btn = document.getElementById("btnMigrateTags");
